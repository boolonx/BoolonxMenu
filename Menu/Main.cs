...
using static BoolonxMenu.Menu.Buttons;
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void Prefix()
        {
            // Initialize Menu
                try
                {
                    ...
                    else
                    {
                        ...
                        comp.angularVelocity = Plugin.handTracker.GetAngularVelocity();
                            Destroy(menu, 2f);
                            menu = null;
            ...
            // Constant
                try
                {
                string fpsstring = "FPS: " + Mathf.Ceil(1f / Time.unscaledDeltaTime).ToString();
                // Pre-Execution
                if (fpsObject != null)
                            fpsObject.text = $"{fpsstring} || Players Online: {PhotonNetwork.CountOfPlayers}";
        ...
        {
            float playasize = GorillaTagger.Instance.offlineVRRig.scaleFactor;
            // Menu Holder
            menu = GameObject.CreatePrimitive(PrimitiveType.Cube);
                Destroy(menu.GetComponent<Rigidbody>());
                Destroy(menu.GetComponent<BoxCollider>());
                Destroy(menu.GetComponent<Renderer>());
            menu.transform.localScale = new Vector3(0.1f, 0.3f, 0.3825f) * playasize;
            ...
            // Menu Background
                ...
                menuBackground.transform.position = new Vector3(0.05f, 0f, 0f) * playasize;
            ...
            // Title and FPS
                ...
                text.font = BoolonxMenu.Plugin.menuFontAsset;
                ...
                component.sizeDelta = new Vector2(0.28f, 0.05f) * playasize;
                component.position = new Vector3(0.06f, 0f, 0.165f) * playasize;
                ...
                if (fpsCounter)
                {
                    ...
                    fpsObject.font = BoolonxMenu.Plugin.menuFontAsset;
                    ...
                    component2.sizeDelta = new Vector2(0.28f, 0.02f) * playasize;
                    component2.position = new Vector3(0.06f, 0f, 0.135f) * playasize;
            ...
            // Buttons
                // Disconnect
                    ...
                    Classes.Button evacclass = disconnectbutton.AddComponent<Classes.Button>();
                    evacclass.relatedText = "Evacuate";
                evacclass.EvacuateButton = true;
                ...
                colorChanger = disconnectbutton.AddComponent<ColorChanger>();
                        ...
                        discontext.text = "Evacuate";
                        discontext.font = BoolonxMenu.Plugin.menuFontAsset;
                        ...
                        rectt.sizeDelta = new Vector2(0.2f, 0.03f) * playasize;
                        rectt.localPosition = new Vector3(0.064f, 0f, 0.23f) * playasize;
                ...
                // Page Buttons
                    ...
                    component.localPosition = Vector3.zero;
                    component.sizeDelta = new Vector2(0.2f, 0.03f) * playasize;
                    component.localPosition = new Vector3(0.064f, 0.195f, 0f) * playasize;
                    component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
                    ...
                    gameObject.transform.parent = menu.transform;
                    gameObject.transform.rotation = Quaternion.identity;
                    gameObject.transform.localScale = new Vector3(0.09f, 0.2f, 0.9f) * playasize;
                    gameObject.transform.localPosition = new Vector3(0.56f, -0.65f, 0) * playasize;
                    gameObject.GetComponent<Renderer>().material.color = buttonColors[0].colors[0].color;
